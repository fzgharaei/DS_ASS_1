...
public class COMPServer extends UnicastRemoteObject implements RMIDepartment{
    ...
    private COMPServer() throws RemoteException{
    ...
    public static COMPServer getDepartment() throws RemoteException{
        if(singleDept == null)
    ...
    public void receive(){
        ...
        try {
            ...
            System.out.println("Server COMP Started............");
            while (true) {
