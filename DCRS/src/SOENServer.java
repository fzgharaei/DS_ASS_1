...
public class SOENServer extends UnicastRemoteObject implements RMIDepartment{
    ...
    private SOENServer() throws RemoteException{
    ...
    public static SOENServer getDepartment() throws RemoteException{
        if(singleDept == null)
            synchronized(SOENServer.class){ //double checked locking
                if(singleDept == null)
    ...
    public void init(int port) throws RemoteException, AlreadyBoundException {
        ...
        RMIDepartment stubs = SOENServer.getDepartment();
    ...
    public void enrolCourse(String studentId, String courseId, char semester)throws RemoteException{
        ...
        if(cfound && sfound) stu.addCourse(semester, selected);
    }
